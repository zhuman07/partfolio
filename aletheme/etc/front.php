...
function ale_enqueue_styles() {
	...
	wp_register_style( 'my_bootstrap', THEME_URL . '/libs/bootstrap/bootstrap-grid.min.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_fontawesome', THEME_URL . '/libs/font-awesome/css/font-awesome.min.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_linea', THEME_URL . '/libs/linea/styles.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_popup', THEME_URL . '/libs/magnific-popup/magnific-popup.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_animate', THEME_URL . '/libs/animate/animate.min.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_fonts', THEME_URL . '/css/fonts.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_header', THEME_URL . '/css/header.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_main', THEME_URL . '/css/main.css', array(), ALETHEME_THEME_VERSION, 'all');
  wp_register_style( 'my_skin', THEME_URL . '/css/skins/tomato.css', array(), ALETHEME_THEME_VERSION, 'all');

    wp_enqueue_style('my_bootstrap');
    wp_enqueue_style('my_fontawesome');
    wp_enqueue_style('my_linea');
    wp_enqueue_style('my_popup');
    wp_enqueue_style('my_animate');
    wp_enqueue_style('my_fonts');
    wp_enqueue_style('my_header');
    wp_enqueue_style('my_main');
    wp_enqueue_style('my_skin');
}
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'my_jquery', THEME_URL . '/libs/jquery/jquery-2.1.3.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'my_paralax', THEME_URL . '/libs/parallax/parallax.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'my_jspopup', THEME_URL . '/libs/magnific-popup/jquery.magnific-popup.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'my_mixit', THEME_URL . '/libs/mixitup/mixitup.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'my_waypoint', THEME_URL . '/libs/waypoints/waypoints.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'my_animatejs', THEME_URL . '/libs/animate/animate-css.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'my_jsvalidate', THEME_URL . '/libs/jqBootstrapValidation/jqBootstrapValidation.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'my_js', THEME_URL . '/js/common.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

    wp_enqueue_script( 'my_jquery' );
    wp_enqueue_script( 'my_paralax' );
    wp_enqueue_script( 'my_jspopup' );
    wp_enqueue_script( 'my_mixit' );
		wp_enqueue_script( 'my_waypoint' );
		wp_enqueue_script( 'my_animatejs' );
		wp_enqueue_script( 'my_jsvalidate' );
