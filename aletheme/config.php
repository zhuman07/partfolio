...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Site header Background image",
                        "desc" => "Upload or put the background image (Default image size: full width)",
                        "id" => "ale_headbg",
                        "std" => "",
                        "type" => "upload");
   ...
   /* $options[] = array( "name" => "Typography",
    ...
    $options[] = array( 'name' => "H2 Style",
                        ...
                        'id' => 'ale_h2sty',
                        'std' => array('size' => '20px','face' => 'Raleway','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');
    ...
    $options[] = array( 'name' => "Body Style",
                        ...
                        'id' => 'ale_bodystyle',
                        'std' => array('size' => '16px','face' => 'Raleway','style' => 'normal','color' => '#222'),
                        'type' => 'typography'); */
...
function aletheme_metaboxes($meta_boxes) {
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            ...
            array(
                'name' => 'First Column upload image',
                'desc' => 'Upload the image',
                'id'   => $prefix . 'col_1_cont',
                'type' => 'file',
            ),
            array(
                'name' => 'Second Column',
                'desc' => 'Insert the Header second col',
                'id'   => $prefix . 'col_2_h',
                'type' => 'text',
            ),
            array(
                'name' => 'Second Column author name',
                'desc' => 'Insert the Header second col',
                'id'   => $prefix . 'col_2_author_name',
                'type' => 'text',
            ),
            array(
                'name' => 'Second Column Textarea',
                'desc' => 'Insert the text',
                'id'   => $prefix . 'col_2_cont',
                'type' => 'wysiwyg',
            ),
            array(
                'name' => 'Thrth Column',
            ...
            array(
                'name' => 'Tirth column textarea',
                'desc' => 'Insert the text',
                'id'   => $prefix . 'col_3_cont',
                'type' => 'wysiwyg',
            ),
            array(
                'name' => 'Fourth Column',
            ...
            array(
                'name' => 'Fourth column textarea',
                'desc' => 'Insert the text',
                'id'   => $prefix . 'col_4_cont',
                'type' => 'wysiwyg',
            ),
        )
    );
